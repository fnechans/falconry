...
HTCondor is powerful tool for management of jobs on computation clusters. It, and especially its python API, can be a bit complicated to use for an usual user.
